...
const Cookies = () => {
  ...
  return (
    <>
      {showCookie && (
        <div>
          <section className='w-screen h-screen backdrop-blur-md fixed bg-gradient-to-b from-black via-[#1d1d1d] to-[#9c9c9c85] z-50 md:h-72 lg:h-32 md:bottom-0 md:bg-gradient-to-b md:from-white/50 md:via-black'>
