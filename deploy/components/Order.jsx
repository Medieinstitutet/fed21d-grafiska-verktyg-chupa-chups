...
const order = () => {
	return (
		<>
			<section className='mt-40 flex flex-col items-center space-between border-b-2 md:border-t-2 md:w-[90vw] md:ml-[5vw]'>
				...
				<div className=' text-white bg-gradient-to-br from-[#545353] to-[#111111] rounded-2xl border border-[#959494] shadow-sm shadow-[#282727] font-form mx-4 px-10 md:mx-48 md:px-4'>
