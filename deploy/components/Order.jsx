...
const order = () => {
  return (
    <>
      <section className='mt-40 flex flex-col items-center space-between border-b-2 md:border-t-2'>
        <h3 className='font-heading text-white mb-4 text-3xl md:mt-32'>
          PICK YOUR COLOR HERE
        </h3>
        <div className='mx-12 md:mx-40'>
          <Image src={Lightsabers} />
        </div>
        <div className=' text-white bg-gradient-to-br from-[#545353] to-[#111111] rounded-2xl border border-[#959494] shadow-sm shadow-[#282727] font-form mx-4 px-10 md:mx-60 md:px-4'>
        ...
        <button className='bg-[#FBC53B] max-w-max text-black hover:text-[#D49900] hover:bg-black font-bold py-2 px-4 mt-6 border-b-2 border-[#D49900]  rounded-md '>
