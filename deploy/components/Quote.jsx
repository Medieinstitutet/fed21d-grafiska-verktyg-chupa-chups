...
const Quote = () => {
  return (
    <div className='flex flex-row m-1 justify-center items-center space-x-4 ml-4 md:justify-start md:ml-28 md:mt-10 lg:ml-6 lg:m-3'>
      <Image alt='Image of Grogu from the Mandalorian' src={grogu} />
